               ...
               <div className="w-full min-h-[450px]  flex justify-center items-center gap-6 flex-col md:flex-row">
                  ...
                  <div className="px-2 h-full w-full text-white flex flex-col gap-2 justify-between">
                     ...
                     <div className="flex flex-col md:flex-row items-start md:items-center h-auto md:h-16 gap-5 md:gap-10 justify-start">
                        ...
                        >
                           <PlayIcon />
                           <span className="text-xl font-light transition-all duration-300 hover:italic ease-in-out">
                              Watch Now
                           </span>
                        </div>
                        <div className="flex flex-col items-center">
                           <StarRate
                              ...
                              size={30}
                              isHalf={true}
                              emptyIcon={<i className="fi fi-rr-star"></i>}
                              halfIcon={
                                 <i className="fi fi-rr-star-sharp-half-stroke"></i>
                              }
                              filledIcon={<i className="fi fi-sr-star"></i>}
                              activeColor="#F31260"
                              edit={true}
                              color={"grey"}
                              onChange={(value: any) => {
